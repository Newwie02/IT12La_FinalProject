...
// GigMatch — Messages screen (placeholder conversation list)
    ...
    <View style={styles.page}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <View style={styles.placeholderCard}>
          <Ionicons name="chatbubble-ellipses-outline" size={28} color="#7c3aed" />
          <Text style={styles.placeholderText}>
            Your conversations with bands, musicians, and clients will show up here once messaging is wired up.
          </Text>
        </View>
      </ScrollView>
      <BottomNav
