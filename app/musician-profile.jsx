...
// GigMatch — Musician profile detail screen (reached by tapping a fellow
// musician card). Route: app/musician-profile.jsx  →  "/musician-profile"
  ...
  return (
    <View style={styles.page}>
      ...
      <ScrollView contentContainerStyle={styles.scrollContent}>
        ...
        <Text style={styles.name}>{name ?? "Musician"}</Text>
        <Text style={styles.tags}>{tags ?? ""}</Text>

        <View style={styles.card}>
          <Text style={styles.cardLabel}>About</Text>
          <Text style={styles.cardBody}>
            This is a placeholder musician profile — bio, past gigs, availability, and a
            booking button will go here once real profile data is wired up.
          </Text>
        </View>
